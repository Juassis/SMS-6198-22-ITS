...
ggsave("./PLOTS/Full_Data/Evaluation/05-Rarefaction.pdf")
...
```{r,fig.cap="Beta Diversity Main Analysis.",  fig.width = 14.5, fig.height = 7.58, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r,fig.cap="AlphaDiversity Main Analysis.",  fig.width = 24.5, fig.height = 17.58, echo=FALSE, warning=FALSE, message=FALSE}
